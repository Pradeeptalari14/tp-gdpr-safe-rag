...
> GDPR audit toolkit tracking retrieval pathways and sanitizing prompt logs prior to external APIs calls.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/gdpr-safe-rag/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-gdpr-safe-rag.git
cd tp-gdpr-safe-rag
```
...
```bash
kubectl port-forward deployment/tp-gdpr-safe-rag 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── gdpr_toolkit.py     # Main configuration file
```
...
---
*Generated by [gdpr-safe-rag Studio](https://pradeeptalari14.github.io/portfolio/tools/gdpr-safe-rag/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
